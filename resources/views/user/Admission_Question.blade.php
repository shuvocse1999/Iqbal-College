  ...
  <div class="col-sm-12 col-12" id="mainpage">
   ...
   <div class="col-sm-12 col-12 p-0"  data-aos="fade-in" data-aos-duration="2000" >
    <ul class="list-group p-0">
      <li class="list-group-item font-weight-bold bg-success text-light" id="about">Admission Test Question</li>
            ...
            <tbody>
              ...
              <tr style="font-size: 12px;">
                ...
                <td>
                  ...
                  <a  href="{{ url($notices->image) }}" class="btn btn-sm btn-danger" >
