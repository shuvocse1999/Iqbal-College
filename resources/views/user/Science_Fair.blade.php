   ...
   <div class="col-sm-9 col-12">
     ...
     <div class="col-sm-12 col-12 p-0"  data-aos="fade-in" data-aos-duration="2000" >
       <ul class="list-group p-0">
        <li class="list-group-item font-weight-bold bg-success text-light" id="about">Science Fair News</li>
      </ul>
      <li class="list-group-item pb-5">
        ...
        <div class="row mt-3 border p-3">
          ...
          <div class="col-md-9 col-12">
            <h4><a href="{{ url('view_Science_Fair/'.$v->id) }}" class="text-dark">{{ $v->title }}</a></h4>
