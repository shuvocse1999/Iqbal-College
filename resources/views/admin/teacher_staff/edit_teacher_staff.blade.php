	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ asset('public/admin') }}/assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Edit Teacher/Staff</h3>
			</div>
						...
						<form method="post" action="{{ url('update_teacherstaff/'.$view->id) }}" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="form-group col-md-4">
									...
									<select class="form-control selecttextfill" name="department_name" id="option_s1">
								...
								<div class="form-group col-md-4">
									...
									<input type="date" name="date_of_birth" class="form-control" required="" value="{{ $view->date_of_birth }}">
								</div>
