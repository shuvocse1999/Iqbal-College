	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ asset('public/admin') }}/assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Useful Link</h3>
			</div>
					...
					<div class="card-body">
						<form method="post" action="" class="btn-submit">
							<div class="row">
								...
								<div class="form-group col-md-12">
									<label>URL :</label>
									<input type="text" name="url" class="form-control" placeholder="URL" id="url" required=""> 
								</div>
							...
							<table id="bs4-table" class="table table-bordered" cellspacing="0">
								...
								<tbody>
									...
									<tr id="tr{{ $v->id }}">
										<td>{{ $i }}</td>
										<td>{{ $v->title }}</td>
										<td><a href="{{ $v->url }}" target="blank">{{ $v->url }}</a></td>
										<td>
											<div class="dropdown ">
