	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ asset('public/admin') }}/assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Contact Information</h3>
			</div>
						...
						<form method="post" action="" class="btn-submit" data-id="{{ $view->id }}">
							<div class="row">
								<div class="form-group col-md-12">
									<label>Details :</label>
									<textarea  id="summernote" class="form-control" name="Contact_Us">{{ $view->Contact_Us }}</textarea>
								</div>


								<div class="form-group col-md-12">
									<label>Map :</label>
									<textarea rows="3" name="map" class="form-control" placeholder="Map">{{ $view->map }}</textarea>
								</div>
