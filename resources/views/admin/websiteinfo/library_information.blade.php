	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ asset('public/admin') }}/assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Library Information</h3>
			</div>
						...
						<form method="post" action="" class="btn-submit" data-id="{{ $view->id }}">
							<div class="row">
								<div class="form-group col-md-12">
									<label>Details :</label>
									<textarea  id="summernote" class="form-control" name="library_information">{{ $view->library_information }}</textarea>
								</div>
