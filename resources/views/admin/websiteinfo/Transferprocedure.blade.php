	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ asset('public/admin') }}/assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Transfer Procedure</h3>
			</div>
										...
										<td>
											<div class="dropdown ">
												...
												<div class="dropdown-menu ">
													<a class="dropdown-item text-dark" href="{{ url('edit_Transferprocedure/'.$v->id) }}"><i class="fa fa-edit pr-2"></i>Edit</a>
...
<script type="text/javascript">
	...
	$(".btn-submit").submit(function(e){
		...
		$.ajax({
			url:"{{ url('insertTransferprocedure') }}",
			method:'POST',
			data:data,
	...
	$(".edit").click(function(){
		...
		$.ajax(
		{
			url: "{{ url('edit_Transferprocedure') }}/"+id,
			type: 'get',
			data:{},
	...
	$(".delete").click(function(){
		...
		$.ajax(
		{
			url: "{{ url('deleteTransferprocedure') }}/"+id,
			type: 'get',
			success: function ()
			{
				$('#tr'+id).hide();
