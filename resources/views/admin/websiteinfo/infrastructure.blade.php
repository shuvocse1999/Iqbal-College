	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ asset('public/admin') }}/assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Infrastructure</h3>
			</div>
...
<script type="text/javascript">
	...
	$(".btn-submit").submit(function(e){
		...
		$.ajax({
			url:"{{ url('infrastructureupdate') }}/"+id,
			method:'POST',
			data:data,
