	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ asset('public/admin') }}/assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Red Crescent</h3>
			</div>
			...
			<div class="container-fluid mt-4">
				<div class="card mb-4 border-0">
					...
					<div class="card-body">
						<form method="post" action="{{ url('insertred_crescent') }}" enctype="multipart/form-data">
										...
										<td>
											<div class="dropdown ">
												...
												<div class="dropdown-menu ">
													<a class="dropdown-item text-dark" href="{{ url('edit_red_crescent/'. $v->id) }}"><i class="fa fa-edit pr-2"></i>Edit</a>
