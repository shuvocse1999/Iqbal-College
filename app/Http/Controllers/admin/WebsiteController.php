...
class WebsiteController extends Controller
{
	...
	public function insertphoto_gallery(Request $request){
		...
		if ($newsimage) {
			...
			Image::make($newsimage)->save('public/photo_gallery/'.$image_one_name,50);
			$data['image']='public/photo_gallery/'.$image_one_name;
	...
	public function principle_messageupdate(Request $request,$id){
		...
		if ($newsimage) {
			unlink($old_image);
			$image_one_name= hexdec(uniqid()).'.'.$newsimage->getClientOriginalExtension();
			Image::make($newsimage)->save('public/message/'.$image_one_name,50);
			$data['image']='public/message/'.$image_one_name;
	...
	public function updatesetting(Request $request,$id){
		...
		if ($newsimage) {
			unlink($old_image);
			$image_one_name= hexdec(uniqid()).'.'.$newsimage->getClientOriginalExtension();
			Image::make($newsimage)->save('public/settings/'.$image_one_name,50);
			$data['image']='public/settings/'.$image_one_name;
