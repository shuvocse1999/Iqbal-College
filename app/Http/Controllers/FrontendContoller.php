...
class FrontendContoller extends Controller
{
	...
	public function index(){
		...
		$noticeview = DB::table('notice')->orderBy('id','DESC')->get();
	...
	public function Photo_gallery(){
		$view = DB::table('photo_gallery')->orderBy('id','DESC')->get();
	...
	public function Teacher_info(){
		$teacherview = DB::table('teacher_staff')->where('type',0)->where('status',NULL)->simplePaginate(12);
	...
	public function Ex_member_list(){
		$memberview = DB::table('lists')->where('type',4)->where('status',1)->simplePaginate(12);
